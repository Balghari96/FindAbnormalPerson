...
public class ObjectHeightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_object_height);
    ...
    public void onButtonClick(View view) {
        ...
        if (!heightBox.getText().toString().isEmpty()) {
            if (view.getId() == R.id.button1) {
                ...
                if (finalDisp < 0) finalDisp = 1;
                double finalDispInFeets = (userHeight + finalDisp) * 3.28084;

                String finalInMeter = String.valueOf(new DecimalFormat("#.##").format(
                        (userHeight + finalDisp)));
                ...
                pDialog.setContentText("These measurements depend on you phone camera and internet");
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        pDialog.dismiss();
                        new SweetAlertDialog(ObjectHeightActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                                .setTitleText("Object Measurements of given points")
            ...
            new SweetAlertDialog(ObjectHeightActivity.this, SweetAlertDialog.ERROR_TYPE)
